    ...
    <div class="header-box">
      <div class="header-top">
        ...
        <ul class="header-top-nologin" v-show="!$store.state.loginStatus">
          <router-link to="/login" tag="li"><a href="javascript:;">亲，请登陆</a></router-link>
          <router-link to="/login?id=register" tag="li"><a href="javascript:;">用户注册</a></router-link>
          <router-link to="" tag="li"><a href="javascript:;">在线客服</a></router-link>
        </ul>
        <ul class="header-top-login" v-show="$store.state.loginStatus">
          <router-link to="" tag="li"><img src="../../assets/img/header/1.jpg" alt=""/><span>nathantest</span></router-link>
          <router-link to="" tag="li"><a href="javascript:;">我的账户</a></router-link>
          <router-link to="" tag="li"><a href="javascript:;">余额：</a></router-link>
          <router-link to="" tag="li"><a href="javascript:;">充值</a></router-link>
          <router-link to="" tag="li"><a href="javascript:;">提现</a></router-link>
...
export default {
  ...
  methods: {
    ...
    logOut() {
      this.$axios.get(baseUrl + "/api/user/logout").then(res => {
        if(this.$store.state.loginStatus === Boolean(localStorage.getItem("loginStatus"))){
          console.log("yes")
        }
